...
export NIAH_TOPO="MI300X 1P1D EP8 (disagg, /v1/completions) [v0.24 REBASE: 6-field 47766 + full DSA fixes + baton self-heal]"
...
bash glm5.1_notes/run_one_config.sh 1 1 niah_rebase_batonfix_1p1d_cmpl niah
