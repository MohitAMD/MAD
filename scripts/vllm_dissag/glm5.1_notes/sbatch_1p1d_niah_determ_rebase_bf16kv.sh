...
# =============================================================================
#SBATCH --job-name=glm_1p1d_determ_rebase_bf16kv
...
export NIAH_TOPO="MI300X 1P1D EP8 (disagg, /v1/completions) [DETERM PROBE x6 | v0.24 rebase+batonfix | bf16 KV | vs fp8=203604]"
...
echo "=== launching 1p1d NIAH determ REBASE BF16-KV /v1/completions (job $SLURM_JOB_ID) ==="
bash glm5.1_notes/run_one_config.sh 1 1 niah_determ_rebase_bf16kv_1p1d niah
