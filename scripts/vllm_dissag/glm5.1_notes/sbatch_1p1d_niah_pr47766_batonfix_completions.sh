...
# aiter JIT baton (vllm-disagg:glmv5.1-v0.24-pr47766-baked-batonfix), via /v1/completions.
...
# =============================================================================
#SBATCH --job-name=glm_1p1d_niah_pr47766_batonfix
...
export NIAH_TOPO="MI300X 1P1D EP8 (disagg, /v1/completions) [v0.24.0 + PR#47766 6-field + patchers baked + baton self-heal]"
...
bash glm5.1_notes/run_one_config.sh 1 1 niah_pr47766_batonfix_1p1d_cmpl niah
