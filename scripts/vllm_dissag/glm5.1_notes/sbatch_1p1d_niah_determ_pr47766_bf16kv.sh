...
# =============================================================================
#SBATCH --job-name=glm_1p1d_determ_pr47766_bf16kv
...
# bf16 KV -> Phase-1a test: does fp8-KV transfer/reindex precision drive the extra disagg variance?
# NOTE: vLLM's --kv-cache-dtype enum spells bf16 as "bfloat16" ("bf16" is rejected at arg-parse).
...
export NIAH_TOPO="MI300X 1P1D EP8 (disagg, /v1/completions) [DETERM PROBE x6 | v0.24.0+PR#47766 minimal | bf16 KV]"
...
echo "=== launching 1p1d NIAH determ pr47766-minimal BF16-KV /v1/completions (job $SLURM_JOB_ID) ==="
bash glm5.1_notes/run_one_config.sh 1 1 niah_determ_pr47766_bf16kv_1p1d niah
