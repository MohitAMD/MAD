...
# =============================================================================
#SBATCH --job-name=glm_2p2d_old_skip1
...
# --- EXPERIMENT: old b10a9f7a base image, patchers SKIPPED (skip1) ------------
...
bash glm5.1_notes/run_one_config.sh 2 2 2p2d_old_skip1 long_context
