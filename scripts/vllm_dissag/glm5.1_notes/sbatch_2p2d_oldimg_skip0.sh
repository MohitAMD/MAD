...
# =============================================================================
#SBATCH --job-name=glm_2p2d_old_skip0
...
# --- EXPERIMENT: old b10a9f7a base image, patchers APPLIED (skip0) ------------
export DOCKER_IMAGE_NAME=rocmshared/pytorch-private:mori-ep-fullsource-vllm-b10a9f7a-20260618
...
bash glm5.1_notes/run_one_config.sh 2 2 2p2d_old_skip0 long_context
