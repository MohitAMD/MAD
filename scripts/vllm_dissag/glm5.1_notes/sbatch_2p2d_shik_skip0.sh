...
# =============================================================================
#SBATCH --job-name=glm_2p2d_shik_skip0
...
# --- EXPERIMENT: shik-latest baked-fix image, patchers APPLIED (skip0) --------
# (identical to 201176 except GLM_SKIP_PATCHERS=0; tests whether patching a
#  baked image regresses it, per the moriio.sh warning.)
...
bash glm5.1_notes/run_one_config.sh 2 2 2p2d_shik_skip0 long_context
