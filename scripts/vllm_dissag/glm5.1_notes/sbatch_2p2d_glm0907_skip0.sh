...
# =============================================================================
#SBATCH --job-name=glm_2p2d_glm0907_skip0
...
# --- EXPERIMENT: glm-dockerimage-built-09072026 base, patchers APPLIED (skip0) --
export DOCKER_IMAGE_NAME=rocm/pytorch-private:glm-dockerimage-built-09072026
...
bash glm5.1_notes/run_one_config.sh 2 2 2p2d_glm0907_skip0 long_context
