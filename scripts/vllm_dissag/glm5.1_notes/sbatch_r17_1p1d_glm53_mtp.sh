...
#     --exclude=useocpm2m-097-[119,135,142] --job-name=r17_1p1d_glm53_mtp \
#     glm5.1_notes/sbatch_r17_1p1d_glm53_mtp.sh
# =============================================================================
#SBATCH --job-name=r17_1p1d_glm53_mtp
...
run_perf "8000/1000"  "1 4 8 16 32"  r17_1p1d_glm53_mtp_8k1k
run_perf "8000/8000"  "1 4 8"        r17_1p1d_glm53_mtp_8k8k
